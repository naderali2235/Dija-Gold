...
export default function Dashboard() {
  ...
  const goldRates = {
    '24k': { rate: GOLD_RATES_EGP['24k'], change: +12.30, changePercent: +0.19 },
    '22k': { rate: GOLD_RATES_EGP['22k'], change: +11.28, changePercent: +0.19 },
    '18k': { rate: GOLD_RATES_EGP['18k'], change: +9.23, changePercent: +0.19 },
    '14k': { rate: GOLD_RATES_EGP['14k'], change: +7.18, changePercent: +0.19 },
  };
    ...
    <div className="space-y-6">
      ...
      <Card className="pos-card">
        <CardHeader>
          ...
          <CardDescription>Current market rates per gram in Egyptian Pounds</CardDescription>
        </CardHeader>
        <CardContent>
